...
import SelectRatings from '@/components/SelectRatings/page'

const FeedBackModal: FC<{ isOpenFeedBackModal: any, closeFeedBackModal: any }> = ({ isOpenFeedBackModal, closeFeedBackModal }): ReactElement => {
  return (
   <>
     <Transition appear show={isOpenFeedBackModal} as={Fragment}>
        <Dialog as="div" className="relative z-20" onClose={closeFeedBackModal}>
          <Transition.Child
            as={Fragment}
                ...
                <Dialog.Panel className="relative w-full max-w-2xl transform rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-5">
                    <form>
                        ...
                        <div className="mb-4">
                            <LabelText text='Overall Experience'/>
                            <SelectRatings/>
                        </div>
                        <div className="mb-4">
                            <LabelText text='Brief your experience'/>
