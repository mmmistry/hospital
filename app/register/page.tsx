...
import PatientRegister from './PatientRegister/page'
import DoctorsRegister from '../doctor/register/page'
        ...
        <div className='lg:flex'>
          ...
          <div className='right-col lg:w-1/2 lg:pl-5 pt-4'>
            <div className='lg:max-w-xl mx-auto'>
              <div className='mb-3'><TitleMd text='Register' /></div>
              <InfoTextMd text='Join us today and unlock a world of possibilities!' />
              <Tab.Group>
